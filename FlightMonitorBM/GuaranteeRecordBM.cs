...
namespace AirSoft.FlightMonitor.FlightMonitorBM
{
    ...
    /// 修改日期：
    /// 版    本：
    public class GuaranteeRecordBM
    {

        #region 声明
        private int _cniguaranteerecordid;
        ...
        private DateTime _cndguaranteetime;
        private string _cnvcguaranteecontent;
        ...
        /// 
        /// </summary>
        public int cniGuaranteeRecordID
        {
            set { _cniguaranteerecordid = value; }
            get { return _cniguaranteerecordid; }
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 保障时间
        /// </summary>
        public DateTime cndGuaranteeTime
        {
            set { _cndguaranteetime = value; }
            get { return _cndguaranteetime; }
        }
        /// <summary>
        /// 保障日志内容
        /// </summary>
        public string cnvcGuaranteeContent
        {
            set { _cnvcguaranteecontent = value; }
            get { return _cnvcguaranteecontent; }
        }
        /// <summary>
        /// 操作时间
        /// </summary>
        ...
        public GuaranteeRecordBM(DataRow dataRow)
        {
            try
            {
                _cniguaranteerecordid = Convert.ToInt32( dataRow["cniguaranteerecordid"].ToString());
                ...
                _cniguaranteerecordcaptionid = Convert.ToInt32( dataRow["cniguaranteerecordcaptionid"].ToString());
                _cndguaranteetime = Convert.ToDateTime( dataRow["cndguaranteetime"].ToString());
                _cnvcguaranteecontent = dataRow["cnvcguaranteecontent"].ToString();
