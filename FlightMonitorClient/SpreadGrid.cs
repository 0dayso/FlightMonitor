        ...
        public void SetView(FarPoint.Win.Spread.SheetView shGrid, DataTable dataItems, int iChild)
        {
            ...
            foreach (DataRow rowItem in dtDataItems.Rows)
            {
                ...
                else   
                {
                    ...
                    //列宽
                    //shGrid.Columns[iIndex].Width = dataItemPurviewBM.ColumnWidth; //原来的代码J
                    #region 列宽自适应文字 modified by LinYong in 20140708
                    int singleWordWidth = 16;   //单个中文字占用的宽度

                    if (iColumnGroupCount == 1) //第 1 列时
                    {
                    ...
                    #endregion 列宽自适应文字 modified by LinYong in 20140708
